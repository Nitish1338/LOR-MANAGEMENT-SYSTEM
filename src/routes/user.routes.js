...
import { registerAsAdmin, updateLORrequest, approveLORrequest, rejectLORrequest, getAllPendingLOR, getAllApprovedLOR, getAllRejectedLOR, findLorsByclassRollNumber, findUserByclassRollNumber, updateUserProfileByclassRollNumber } from "../controllers/admin.controller.js";
...
router.route("/registerAsAdmin").post(userAuth, isAdminAuth, registerAsAdmin); // We have To modify this in later- Set that Only admin can enroll other Admin
...
router.route("/:classRollNumber/findLorsByclassRollNumber").get(userAuth, isAdminAuth, findLorsByclassRollNumber);
router.route("/:classRollNumber/findUserByclassRollNumber").get(userAuth, isAdminAuth, findUserByclassRollNumber);
router.route("/:classRollNumber/updateUserProfileByclassRollNumber").put(userAuth, isAdminAuth, updateUserProfileByclassRollNumber);
